...
### Смирнова Е.Н.
+ Изучение документации и требований к проекту: 15 часов
+ Подготовка документации по проекту в сооствестии с гостами и требованиями PSI DSS: 15 часов
+ Соовместная работа над документальным составом в LogicalIT: 20 часов
+ Оценка соотвествия проделанных работ и итогового результата с требованиями технической коммисии: 12 часов
+ Утверждение документации и правки совместно с LogicalIT и МетрикаБ: 15 часов
####        Общий объем работы оценивается в 77 часов 
